...
class CompletePipeline:
    def __init__(self):
        ...
        self.depth_processor = DepthProImageProcessorFast.from_pretrained("apple/DepthPro-hf") # tried many different models, this one works best
    ...
    def run_complete_pipeline(self, image_path, output_dir="./pipeline_output/"):
        ...
        print("🎯 Starting Multi-Object Pipeline.....")
        print("=" * 60)
...
if __name__ == "__main__":
    ...
    # Set your image path
    image_path = "images\Bottle.jpg"  # Replace with your image path
